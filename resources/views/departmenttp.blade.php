			...
			<div class="card-body" >
				...
				{{csrf_field()}}
					<div id="city" class="jumbotron">
				    	...
				    	<input name="departmenttp" class="form-control" placeholder="Enter Department Type" type="text"required pattern="[a-zA-Z][a-zA-Z ]+" title="start with alphabets and include alphabets, space.">
				    	</div>
